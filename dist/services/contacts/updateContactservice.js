...
const updateContactService = (data, idUser, idContact) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield contactRepository.update(idContact, Object.assign(Object.assign({}, contact), { name: data.name ? data.name : contact.name, email: data.email ? data.email : contact.email, phone: data.phone ? data.phone : contact.phone }));
    const updatedContact = yield contactRepository.findOneBy({ id: idContact });
